...
export default function PackagesClassicManager() {
  ...
  const fetchSectionData = async () => {
    try {
      const result = await apiRequest("/wedding-packages/section2", "GET");
      console.log("Fetched classic package data:", result);
      ...
      if (result.success && result.data) {
        ...
        console.log("No classic package data found, using defaults");
      }
    } catch (err) {
  ...
  const saveSection = async () => {
    ...
    try {
      ...
      if (sectionId) {
        ...
        result = await apiRequest(`/admin/wedding-packages/section2/${sectionId}`, "POST", submitData, token, true);
      } else {
        result = await apiRequest("/admin/wedding-packages/section2", "POST", submitData, token, true);
      }
  ...
  return (
    <div className="space-y-6 p-4 sm:p-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h2 className="text-xl font-bold">Classic Package</h2>
          <p className="text-sm text-gray-500">Edit package details with 6 features</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-4 bg-white p-4 sm:p-6 rounded-xl border shadow-sm">
          ...
          <div>
            <label className="block text-sm font-medium mb-2">Package Features (6 items)</label>
