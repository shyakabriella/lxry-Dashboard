...
const sectionLabels = {
  hero: "Services Hero",
  luxury_wedding_venues_in_kigali_rwanda: "Luxury Wedding Venues",
  seamless_wedding_experience: "Seamless Experience",
  catering: "Catering",
...
export default function WeddingServicesManagerMicroService() {
  ...
  const isLuxury = activeSection === "luxury_wedding_venues_in_kigali_rwanda";

  const isSeamless = activeSection === "seamless_wedding_experience";
  ...
  return (
    <section className="mt-10 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <h2 className="text-lg font-bold">Wedding Services</h2>
      ...
      <div className="grid lg:grid-cols-5 gap-6">
        ...
        <div className="lg:col-span-2 bg-white p-4 rounded-xl">
          ...
          <p className="text-sm text-gray-500">{editedSection.subtitle}</p>
        </div>
      </div>
    </section>
  );
