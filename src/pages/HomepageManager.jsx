...
export default function HomepageManager() {
  ...
  const fields = [
    ...
    { key: "content", label: "Content", icon: Type, type: "textarea", placeholder: "Section content text..." },
    { key: "imageUrl", label: "Image URL", icon: Image, type: "url", placeholder: "https://..." },
    { key: "ctaText", label: "Button Text", icon: Link2, type: "text", placeholder: "e.g. Learn More" },
    { key: "ctaLink", label: "Button Link", icon: Link2, type: "text", placeholder: "#section-id" },
  ];
